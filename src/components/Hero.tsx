    ...
    <section id="top" className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-hero">
      ...
      <div className="container relative flex flex-col items-center text-center">
        <div className="animate-fade-up flex flex-col items-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-card/70 backdrop-blur border border-gold/40 text-xs uppercase tracking-[0.25em] text-primary mb-8">
